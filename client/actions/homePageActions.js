...
// 'RETRIEVE_READ_ONLY_Changes' -> Retrieve the list, most likely to an axios call to our backend that takes a flag to return the minimal version
// 'GOOD_READ_ONLY_Changes' -> If the backend returns a 200 and returns the Changes which we can populate
// 'BAD_READ_ONLY_Changes' -> If the backend returns 404, We can update the front end accordingly
// ADD MORE?
